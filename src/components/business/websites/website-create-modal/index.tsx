            ...
            <div className="flex-1 px-6 space-y-6 ">
                ...
                <div>
                    ...
                    <div className="h-11 bg-[#F4F4F7] rounded flex items-center px-4">
                        <span className="text-gray-400">{`${website?.domain ? website?.domain : website?.officialDomain ?`${website?.path??website?.name??''}.${website?.officialDomain}`: userInfo?.defultSiteDomain}`}</span>
                    </div>
